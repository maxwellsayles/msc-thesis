...
% NUDUPL.
\begin{algorithm}[h]
\caption{NUDUPL -- Fast Ideal Squaring. TODO: There's a branch for non-nudupl.}
\label{alg:nudupl}
\begin{algorithmic}[1]
