...
\begin{algorithm}[htb!]
\caption{Computes $g^n$ for immutable $n$ using only one inverse and a R2L NAF. Concept from \cite[p.4]{Joye2000}}\label{alg:nafR2LImmutable}
\begin{algorithmic}[1]
