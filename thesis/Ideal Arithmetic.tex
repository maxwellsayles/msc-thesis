...
By the second generator $s(b+\sqrt\Delta)/2$ of $\mathfrak{a}\mathfrak{b}$ and the entire right hand side of equation \eqref{eq:composeExpanded} there exists $m, n, p, q \in \ZZ$ such that
\begin{equation}
...
\begin{split}
	...
	& = ma_1a_2 + n\frac{a_1b_2}{2} + p\frac{a_2b_1}{2} + q\frac{b_1b_2 + \Delta}{4} + \left(n\frac{a_1}{2} + p\frac{a_2}{2} + q\frac{b_1+b_2}{4}\right)\sqrt\Delta. 
\end{split}
\end{equation}
...
\begin{eqnarray}
	...
	\Rightarrow s & = & na_1 + pa_2 + q\frac{b_1+b_2}{2}. \label{eq:sAsGCD}
\end{eqnarray}
...
\begin{eqnarray}
	...
	\Rightarrow b & \equiv & n\frac{a_1b_2}{s} + p\frac{a_2b_1}{s} + q\frac{b_1b_2 + \Delta}{2s} \pmod{2a} \label{eq:bMod2a}
\end{eqnarray}

\noindent
By equation \eqref{eq:sAsGCD}, we have
\begin{eqnarray*}
	s & = & na_1 + pa_2 + q\frac{b_1+b_2}{2} \\
	\Rightarrow 1 & = & n\frac{a_1}{s} + p\frac{a_2}{s} + q\frac{b_1+b_2}{2s}.
\end{eqnarray*}

\noindent
Substituting into equation \eqref{eq:bMod2a} we get
\[
	b \equiv b_2(1-p\frac{a_2}{s} - q\frac{b_1+b_2}{2s}) + + p\frac{a_2b_1}{s} + q\frac{b_1b_2 + \Delta}{2s} \pmod{2a}
\]
