...
Let $i^2 = -1$.  The discriminant $\Delta'$ of the non-maximal order $[1, 2 i]$ is
\[
...
\noindent
We call $f$ the \emph{conductor} of the non-maximal order $\OO'$.  Notice that in Example \ref{ex:discriminant}, we had $\Delta' = -16 = 4(-4) = f^2\Delta$ where $f = 2$ and $\Delta = -4$.
...
\begin{example}
Let $\OO = [1, i]$ for $i^2 = -1$ be the maximal order in the field $\QQ(i)$ and let 
\[
...
\begin{example}
Let $\OO = [1, i]$ for $i^2 = -1$ be the maximal order in the field $\QQ(i)$ and let $\ideal a = (2, i)$ and $\ideal b = (-3, 6i)$ be two ideals of $\OO$.  Ideals $\ideal a$ and $\ideal b$ are equivalent since
\[
(3i)\ideal a = (1)\ideal b
\]
implies
\[
(3i)(2, i) = (-3, 6i)
\]
where $(3i)$ and $(1)$ are principle ideals of $\OO$.
\end{example}
