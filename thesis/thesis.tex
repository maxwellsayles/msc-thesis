...
\[
P_w / \phi(P_w) \sim e^\gamma \log \log p_t
\]
...
This chapter introduced SPAR, a factoring algorithm based on the ideal class group of imaginary quadratic number fields, and our motivation for practical improvements to the performance of arithmetic in the class group.  The next chapter discusses several techniques used to improve the performance of arithmetic in the class group, as well as our experiments and results.  Similarly, Chapter \ref{chap:ssparExperiments} discusses the techniques, experiments, and results we used to improve the performance of SuperSPAR in practice.
