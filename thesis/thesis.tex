...
In the previous section, we improved upon the original GCD computation by subtracting a multiple $q = \floor{s / t}$ of the smaller number from the larger number.  Derrick Henry Lehmer noticed that for large integers, computing $q$ was expensive and that most of the time the result was small.
