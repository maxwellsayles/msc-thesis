...
% TODO: An example for every definition?
...
% TODO: Our own windowing.  Future work would look for asymptotically optimal window size.
...
%TODO: Introduce Brent \cite{Brent1976}.
...
% TODO: Mike says we should continue with the previous values.  But his code doesn't do this.  I could time it to see which is faster.  It's not obvious from the original text what should be used.
...
% TODO: Insert graph showing that this is faster!
...
% TODO: Compare gpowsg with gmul+gsqr
...
% TODO: Try cancelling an $a_1$ and insert graphs showing reduction after each step, etc.
