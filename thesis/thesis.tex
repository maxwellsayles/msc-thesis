...
Timings can be inaccurate.  Sample set is an approximation.  Therefore, there's no such thing as exact values that give the absolute best timing.  So it's okay to find approximate values using this method.
