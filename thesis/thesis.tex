...
For some square free integer $k$, choose a discriminant $\Delta = -kN$ or $\Delta = -4kN$ such that $\Delta \equiv 0, 1 \pmod 4$.  
...
\begin{algorithm}[h]
\caption{Try to Find an Ambiguous Ideal Class by Repeated Squaring.}
\begin{algorithmic}[1]
...
\begin{algorithm}[h]
\caption{Try Many Ideal Classes.}
\begin{algorithmic}[1]
