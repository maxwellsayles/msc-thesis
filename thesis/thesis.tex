...
For $k \in \{32, 40, 48, 56, 64, 72, 80\}$, 250,000 unique values of $2^{k-1} \le N < 2^k$, 7 mutipliers (1, 2, 3, 5, 6, 7, 10), and the first 5 prime ideal representatives.  This is a total of 8,750,000 ideal representatives for each bit size.
