...
\begin{algorithmic}[1]
\Require $n \in \ZZgez$
\Ensure $n$ satisfying $n = \sum_{i=1}^k s_i 2^{a_i} 3^{b_i}$ with $s_i \in \{1, -1\}$, $a_i < a_{i+1}$, and $b_i < b_{i+1}$ for $1 \le i < k$
\State $(a, b) \gets (0, 0)$
\State $i \gets 1$
\While {$n > 0$}
