...
Even though this algorithm performs well in practice (Subsection \ref{subsec:gcdResults}, unfortunately the operation of dividing $t$, $X$, and $Y$ by 2 and of transforming $X+b$ and $Y-a$ to make them even cannot be expressed as unimodular matrix operations.  Therefore, we could not extend this method to a partial extended GCD computation useful for computing the partially reduced coefficients for ideal multiplication.
