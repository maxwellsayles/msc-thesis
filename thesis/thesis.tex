...
\mygraphTwo{pm_variants-64}{pm_variants-64-zoom}{fig:expPmVariants64}{$k$ Best $(x\pm\cdots)/(2^c3^d)$ (59-bit Discriminants).}
\mygraphTwo{pm_variants-128}{pm_variants-128-zoom}{fig:expPmVariants128}{$k$ Best $(x\pm\cdots)/(2^c3^d)$ (118-bit Discriminants).}
