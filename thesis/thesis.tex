...
\begin{example}
Let $\OO = [1, i]$ for $i^2 = \sqrt{-1}$ be the maximal order in the field $\QQ(i)$ and let $\ideal a = (2, i)$ and $\ideal b = (-3, 6i)$ be two ideals of $\OO$.  Ideals $\ideal a$ and $\ideal b$ are equivalent since
\[
