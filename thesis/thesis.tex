...
This process may be unlucky, and as we shall see in Subsection \ref{subsec:ssparExpIdeals}, if the algorithm has been unsuccessful for more than an expected number of ideal classes within the same class group, the algorithm then changes multipliers and starts over with a different class group.
