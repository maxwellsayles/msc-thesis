...
For example, the set $\stepBounds_{500}$ restricted to pairs using no more than 500 steps is
\begin{align*}
\stepBounds_{500} = \{&(1,1),(1,2),(3,1),(2,2),(5,1),(3,2),(1,3),(5,2),(6,2),(7,2),(2,3),(9,2), \\
...
\end{align*}
and the search reach for each corresponding pair is
\begin{align*}
