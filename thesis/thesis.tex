...
Lastly, since balancing the number of operations between both stages is often not ideal, we choose the bound $b = m P_w$ for the baby steps separately.  Let $s$ be a function from some multiple $m$ of the primorial $P_w$ to the total number of baby steps and giant steps taken during the search stage of the algorithm.  We have
\[
	s(m, w) = 2 m \phi(P_w).
\]
Then, let
